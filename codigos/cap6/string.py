...
Set and Get methods of class String.
'''

STRINGS = {'E':82, 'A':110, 'D':146, 'G':196, 'B':247, 'e':330}
...
class String:
    ...
    def is_tuned(self):
        ...
        if self._frequency == STRINGS[self._name]:
            return True
        else:
            print('The right afination of string {} is {} Hz'.format(self._name, STRINGS[self._name]))
            return False
