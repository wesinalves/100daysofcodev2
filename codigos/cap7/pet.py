...
class Dog(Pet):
    ...
    def __str__(self):
        ...
        return '{:17s} {:s}'.format('Dog', Pet.__str__(self))
...
class Beagle(Dog):
    ...
    def __str__(self):
        ...
        return '{}: {:10s}'.format(Dog.__str__(self), 'Beagle')
...
def main():
    '''Main program'''
    dog_dict = {'name':'snoop', 'age':3, 'weight':13, 'height':15, 'width':30}
    colors = ['black', 'white', 'brown']
    dog = Beagle(colors, **dog_dict)
    print(dog, dog._human_age(dog.age), dog.food())
